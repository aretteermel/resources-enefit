CREATE TYPE resource_type AS ENUM ('METERING_POINT', 'CONNECTION_POINT');
CREATE TYPE characteristic_type AS ENUM ('CONSUMPTION_TYPE', 'CHARGING_POINT', 'CONNECTION_POINT_STATUS');
